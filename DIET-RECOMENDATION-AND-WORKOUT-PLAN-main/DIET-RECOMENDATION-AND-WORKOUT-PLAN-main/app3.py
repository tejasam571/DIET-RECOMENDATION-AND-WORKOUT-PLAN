...
bg_image_path = "background.jpg"  # your uploaded file
bg_base64 = get_base64_of_bin_file(bg_image_path)

# Inject CSS with full-screen background image
page_bg_img = f"""
<style>
...
st.markdown(
    ...
    .center-rectangle {
        ...
        height: 2500px;          /* box height (taller, vertical rectangle) */
...
nutrition_df = pd.read_csv("Dataset/nutrition_distribution_large.csv")
food_df = pd.read_csv("Dataset/food_large.csv")
workout_df = pd.read_csv("Dataset/expanded_workout_plan.csv") # Updated file path
